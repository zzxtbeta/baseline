...
def load_data(dataset_name):
    train_file_path = os.path.join('datasets/bitcoin_alpha', f'{dataset_name}_training.txt')
    val_file_path = os.path.join('datasets/bitcoin_alpha', f'{dataset_name}_validation.txt')
    test_file_path = os.path.join('datasets/bitcoin_alpha', f'{dataset_name}_testing.txt')
